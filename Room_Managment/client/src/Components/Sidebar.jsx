...
//   // Guest navigation items (always visible)
//   const guestItems = [
//     {
//       name: 'Dashboard',
//       path: '/dashboard',
...
//   // User navigation items (only when logged in)
//   const userItems = [
//     {
//       name: 'Dashboard',
//       path: '/dashboard',
...
//     items = items.concat(
//       userItems.filter(item => item.roles.includes(userRole))
//     );

//     if (userRole === 'owner') {
//       items = items.concat(ownerItems);
//     }
//     if (userRole === 'admin') {
...
//             <div className="w-12 h-12 rounded-full overflow-hidden bg-gradient-to-r from-blue-500 to-blue-600 flex-shrink-0 shadow-sm">
...
//               className="flex items-center space-x-3 px-4 py-3 w-full rounded-lg text-slate-600 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200"
//             >
//               <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
