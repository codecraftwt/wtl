    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-600">Loading active bookings...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="bg-gradient-to-r from-yellow-500 to-red-500 px-4 py-2 rounded-lg">
      ...
      {activeBookings.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-12 text-center">
          <div className="flex flex-col items-center">
            <div className="w-20 h-20 bg-gradient-to-r from-yellow-100 to-red-100 rounded-full flex items-center justify-center mb-4">
              <span className="material-icons text-4xl text-red-500">event_busy</span>
            </div>
            <h3 className="text-lg font-semibold text-gray-800 mb-2">No Active Bookings</h3>
        ...
        <div className="space-y-4">
          {activeBookings.map((booking) => (
            <div
              key={booking._id}
              className="bg-white rounded-xl border border-red-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden"
            >
              {/* Status Bar - Yellow/Red Gradient */}
              <div className="bg-gradient-to-r from-yellow-500 to-red-500 px-6 py-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="material-icons text-white text-sm">event_available</span>
                    <span className="text-xs font-medium text-white uppercase tracking-wider">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <span className="material-icons text-gray-400 text-sm">fingerprint</span>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <span className="material-icons text-gray-400 text-sm">payments</span>
                      {booking.isAdvancePaid ? (
                        <span className="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">
                          Paid
                        </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 pt-4 border-t border-gray-100">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="material-icons text-gray-400 text-sm">login</span>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-2 py-1 bg-gradient-to-r from-yellow-500 to-red-500 text-white rounded-full text-xs font-medium">
                          {booking.checkOut ? 'Checked Out' : 'Active'}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
